...
description: Cria subagentes personalizados para tarefas especializadas de IA. Use
  quando quiser criar um novo tipo de subagente, configurar agentes específicos para
  tarefas, configurar revisores de código, depuradores ou assistentes de domínio específico
