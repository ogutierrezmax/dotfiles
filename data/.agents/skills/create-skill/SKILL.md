---
name: create-skill
description: Guia os usuários na criação de Agent Skills eficazes para o Cursor. Use
  quando quiser criar, escrever ou autorizar uma nova skill, ou perguntar sobre a
  estrutura da skill, melhores práticas ou formato SKILL.md.
---
