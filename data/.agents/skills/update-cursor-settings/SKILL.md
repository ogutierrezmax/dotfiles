...
description: Modifica as configurações de usuário do Cursor/VSCode em settings.json.
  Use quando quiser alterar as configurações do editor, preferências, configuração,
  temas, tamanho da fonte, tamanho da guia, formatar ao salvar, salvamento automático,
  atalhos de teclado ou quaisquer valores de settings.json.
metadata:
  surfaces:
  - ide
---
