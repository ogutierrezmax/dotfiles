...
Leia a skill `dotfiles-config-researcher` e execute-a com o nome do programa, enriquecendo o input com o resultado da Etapa P.
...
### Etapa 4 — Documentação e Hook (`dotfiles-doc-writer`)

Leia a skill `dotfiles-doc-writer` e execute-a com todo o contexto acumulado. Em seguida, verifique e instale o hook de pré-commit.
...
2. **Nunca pular etapa** — o `dotfiles-config-researcher` precisa do output da Etapa P; o `llm-config-guardian` precisa do output da Etapa 1
