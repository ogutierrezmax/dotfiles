---
name: "statusline"
description: "Configura uma linha de status personalizada no CLI. Use quando o usuário mencionar linha de status, statusline, statusLine, barra de status do CLI, personalização do rodapé do prompt ou quiser adicionar contexto da sessão acima do prompt."
---
# CLI Status Line
