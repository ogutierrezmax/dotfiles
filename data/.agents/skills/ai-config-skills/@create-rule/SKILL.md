---
name: "@create-rule"
description: "Cria regras do Cursor para orientação persistente da IA. Use quando quiser criar uma regra, adicionar padrões de codificação, configurar convenções de projeto, configurar padrões específicos de arquivos, criar arquivos RULE.md ou perguntar sobre .cursor/rules/ ou AGENTS.md."
---
