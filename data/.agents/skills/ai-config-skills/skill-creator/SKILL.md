---
name: "skill-creator"
description: "Cria novas skills, modifica e melhora skills existentes e mede o desempenho das mesmas. Use quando os usuários quiserem criar uma skill do zero, editar ou otimizar uma skill existente, executar avaliações para testar uma skill, comparar o desempenho com análise de variância ou otimizar a descrição de uma skill para melhor precisão de disparo."
---
