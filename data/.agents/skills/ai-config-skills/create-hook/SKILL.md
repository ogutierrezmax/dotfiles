---
name: "create-hook"
description: "Cria hooks do Cursor. Use quando quiser criar um hook, escrever hooks.json, adicionar scripts de hook ou automatizar comportamentos em torno de eventos do agente."
---
