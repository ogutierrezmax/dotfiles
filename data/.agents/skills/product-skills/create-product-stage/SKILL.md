...
description: "Cria uma nova etapa de artefatos de produto (ex.: estratégia, discovery) com estrutura, pesquisa de mercado e conteúdo denso. Use quando o usuário pedir nova etapa de produto, documentação de fase PM, ou artefatos em /docs/product/ desde o zero."
---
