...
description: "Audita e refina artefatos de uma etapa de produto existente contra padrões de mercado, preenchendo lacunas e reorganizando estrutura. Use quando o usuário pedir revisão de documentação de produto legada, auditoria de /docs/product/, ou alinhamento de uma etapa já criada."
---
