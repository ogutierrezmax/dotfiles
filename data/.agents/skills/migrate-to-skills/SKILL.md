...
description: Converte regras do Cursor (.cursor/rules/*.mdc) e comandos slash (.cursor/commands/*.md)
  para o formato Agent Skills (.cursor/skills/). Use quando quiser migrar regras ou
  comandos para skills, converter regras .mdc para o formato SKILL.md ou consolidar
  comandos no diretório de skills.
