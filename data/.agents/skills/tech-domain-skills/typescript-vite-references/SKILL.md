...
description: "Configura TypeScript com project references (solution) em projetos Vite/React: evita TS6310/TS6306 (composite vs noEmit), define emitDeclarationOnly com outDir seguro, e scripts tsc -b --noEmit. Use ao ver \"referenced project may not disable emit\", \"pode não desabilitar a emissão\", tsconfig com files vazio + references, ou ao alinhar typecheck CI com Vite."
---
