...
description: "Otimização de desempenho do Postgres e melhores práticas do Supabase. Use esta skill ao escrever, revisar ou otimizar consultas Postgres, designs de esquema ou configurações de banco de dados."
---
<!-- license: MIT -->
<!-- metadata:
  author: supabase
