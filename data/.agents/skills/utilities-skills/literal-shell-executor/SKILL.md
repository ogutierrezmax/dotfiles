...
description: "Executa o restante de uma solicitação /shell como um comando literal do shell. Use apenas quando o usuário invocar explicitamente /shell e desejar que o texto seguinte seja executado diretamente no terminal."
---
