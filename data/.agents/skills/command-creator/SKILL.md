...
description: 'Guia a criação de slash commands no Cursor. Use quando o usuário pedir para criar comando, automatizar workflow ou documentar processo em .cursor/commands/.'
---
