...
description: "Checks which code quality tools are installed in the current project. Use when the user asks about installed quality tools, wants to verify tool availability, or mentions SonarQube, code-quality-kit, or similar code analysis tools. Triggers on phrases like \"what quality tools do I have\", \"is sonarqube installed\", \"check quality tools\", \"quality tool status\", or any request to audit code quality tooling."
---
